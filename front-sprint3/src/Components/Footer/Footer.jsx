            ...
            <div className="links__contacts">
              ...
              <div className="col">
                <a href="#" className="contact-icon">
                  <img
                    className="contact-icon__img"
                    src="./img/ico-invoice-and-statement.svg"
            ...
            <ul className="links__companies company-links">
              ...
              <li className="company-links">
                ...
                <ul>
                  ...
                  <li className="company-links__item">
                    <a className="company-links__text" href="#"
                      >Regras e Resultados de Sorteios</a
                    >
                  </li>
                </ul>
              </li>
          ...
          <div className="footer__container payment">
            <div className="payment__alternatives">
              ...
              <img
                ...
                src="./img/ico-cartao-rchlo1.webp"
                alt=""
              />
              <img
                className="payment__img"
                src="./img/ico-cartao-rchlo2.webp"
                alt=""
              />
              <img
                className="payment__img"
                src="./img/ico-cartao-rchlo3.webp"
                alt=""
              />
              <img
                className="payment__img"
                src="./img/ico-cartao-visa.png"
                alt=""
              />
              <img
                className="payment__img"
                src="./img/ico-cartao-master.webp"
                alt=""
              />
              <img
                className="payment__img"
                src="./img/ico-cartao-amex.webp"
                alt=""
              />
              <img
                className="payment__img"
                src="./img/ico-cartao-diners.png"
                alt=""
              />
              <img
                className="payment__img"
                src="./img/ico-cartao-elo.png"
                alt=""
              />
              <img className="payment__img" src="./img/ico-boleto.webp" alt="" />
              <img className="payment__img" src="./img/ico-paypal.png" alt="" />
            </div>
          ...
          <div className="footer__container bottom">
            <div className="copyright">
              <p className="copyright__text">
                ...
                4003-0515.Direção de fotografia de produtos por Adriano
                Adrião.<br />
                Pagamento com Cartão Riachuelo, parcelas mínimas de R$ 15,00.
                Para os demais cartões Visa, Mastercard, Elo, Diners, Hipercard
                e American Express, parcelas mínimas de R$ 30,00.<br />
                * COMPRE NO SITE e RETIRE NA LOJA com FRETE GRÁTIS, conforme
                lojas participantes. Consulte as lojas participantes nas opções
                de frete do seu pedido, conforme CEP de entrega cadastrado.<br />
                ...
                Condição por tempo indeterminado, para tipo de entrega
                “normal”.<br />
                Preços, promoções, condições de pagamento, valores de frete e
                disponibilidade de estoque são aplicados somente nas compras
                efetuadas na loja online Riachuelo. Existe uma limitação de
                peças iguais no mesmo pedido que muda de acordo com o tipo de
                produto.<br />
